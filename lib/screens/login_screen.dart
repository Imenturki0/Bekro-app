                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      const StartPagesHeader(mainText: 'LOGIN INTO YOUR ACCOUNT'),
                      FormInput(
                        hintText: 'Email',
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              if(user!.emailVerified==false){
                                ...
                                final userInfo = await getUserData(user.uid);
                      ...
                      GestureDetector(
                        onTap: () {_goToLink(ForgotPassword.id);},
                        child: const Text(
                          'Forgot Password?',
                      ...
                      GestureDetector(
                        onTap: () {_goToLink(RegistrationScreen.id);},
                        child: RichText(
                          text: const TextSpan(
                            children: <TextSpan>[
