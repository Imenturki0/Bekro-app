                ...
                child: Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      const StartPagesHeader(mainText: 'CREATE YOUR ACCOUNT'),
                      FormInput(
                        hintText: 'Name',
                      ...
                      FormInput(
                        hintText: 'Email',
                        validatorFunction: (value) => validateInputs(value, 'email'),
                        ...
                        onPress: () async {
                          if (_formKey.currentState!.validate()) {
                            ...
                            try {
                              ...
                              if (list.isNotEmpty) {
                                _openAlert('Failed','Email Exists! please use a different one', CoolAlertType.error);
                              } else {
                                _goToAgreement(email, password,name);
                              }
                            } catch (error) {
                              setState(() {showSpinner = false;});
                              _openAlert('Failed','An error has occurred. please try again later', CoolAlertType.error);
                            }
                          }
                        },
                      ),
